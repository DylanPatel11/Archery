...
public class Shoot {
		...
		public String toString() {
			return "Shoot [id=" + id + ", dated=" + dated + ", distance=" + distance + ", targetFace=" + targetFace
					+ ", bowType=" + bowType + ", arrows=" + arrows + ", limbsWeight=" + limbsWeight + ", arrow="
					+ arrow + ", arrowLength=" + arrowLength + ", endsTotal=" + endsTotal + ", totalArrows="
					+ totalArrows + ", totalScore=" + totalScore + "]";
		}
